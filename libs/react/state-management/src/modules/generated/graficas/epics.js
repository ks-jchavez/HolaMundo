...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "graficas" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "graficas" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "graficas" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "graficas" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "graficas" workflow.
 */
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "graficas" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "graficas" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "graficas" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "graficas" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "graficas" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "graficas" workflow.
 */
